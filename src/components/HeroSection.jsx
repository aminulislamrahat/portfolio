    ...
    <div className="container relative mx-auto px-4 pt-16 md:pt-20 flex flex-col md:flex-row items-center justify-between">
      <motion.div className="md:w-1/2 mb-10 md:mb-0" initial={{
        ...
        <motion.div className="flex flex-wrap gap-4" initial={{
          ...
          <motion.a href={`${import.meta.env.BASE_URL}Resume of Md. Aminul Islam Bhuiyan.pdf`} target="_blank" className="px-6 py-3 bg-blue-600 dark:bg-blue-700 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-300 flex items-center gap-2 group" whileHover={{
            scale: 1.05
          }} whileTap={{
            scale: 0.95
          }}>
