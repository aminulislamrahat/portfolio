...
export const ProjectsSection = ({
  ...
  const projects = [{
    ...
    description: 'DoTask is a modern freelance task marketplace platform that connects job seekers with task providers. Users can post tasks, bid on tasks, and collaborate based on skills, budget, and deadlines.',
    ...
    category: 'public',
    images: ['https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80', 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2011&q=80', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2015&q=80'],
    description: 'Track expenses, create budgets, and visualize spending patterns with this finance application.',
    technologies: ['JavaScript', 'Chart.js', 'Firebase', 'CSS3'],
    liveLink: 'https://example.com/finance-app',
    githubLink: 'https://github.com/johndoe/finance-app',
    fullDescription: 'This personal finance application helps users track their spending, set budgets, and visualize their financial patterns. It includes features like expense categorization, budget alerts, and financial goal tracking.',
    challenges: 'Creating intuitive data visualizations that clearly communicate financial patterns was challenging. I conducted user testing to refine the charts and graphs for maximum clarity.',
    futureImprovements: 'Planning to add bank account integration, automated expense categorization using machine learning, and a mobile app version.'
  }, {
    id: 3,
    title: 'Recipe Finder',
    category: 'private',
    images: ['https://images.unsplash.com/photo-1556911220-e15b29be8c8f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80', 'https://images.unsplash.com/photo-1506368249639-73a05d6f6488?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80', 'https://images.unsplash.com/photo-1495521821757-a1efb6729352?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2026&q=80'],
    description: 'Search and save recipes based on ingredients you have. Includes meal planning features.',
    technologies: ['React', 'Redux', 'API Integration', 'Styled Components'],
    liveLink: 'https://example.com/recipe-finder',
    githubLink: 'https://github.com/johndoe/recipe-finder',
    fullDescription: 'Recipe Finder allows users to search for recipes based on ingredients they have on hand, dietary restrictions, and cuisine preferences. Users can save favorites, create meal plans, and generate shopping lists.',
    challenges: 'Integrating with multiple recipe APIs with different data structures required creating a normalized data layer to provide a consistent experience.',
    futureImprovements: 'Planning to add nutritional information, user-contributed recipes, and a recommendation system based on past preferences.'
  }, {
    id: 4,
    title: 'Weather App',
    category: 'private',
          ...
          <div className="p-6">
            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-3">
                ...
                <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
